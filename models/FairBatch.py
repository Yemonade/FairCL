...
class FairBatch(Sampler):
    ...
    Attributes:
        model: A models containing the intermediate states of the training.
    ...
    def __init__(self, model, x_tensor, y_tensor, z_tensor, batch_size, alpha, target_fairness, replacement=False,
                 seed=0):
